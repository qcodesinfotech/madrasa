...
<div class="app-wrapper">
	    ...
	    <div class="app-content pt-9 p-md-3 p-lg-9">
		    <div class="container-xl">
			    
			    <h1 class="app-page-title" style=" text-decoration: underline;">Moon Sight</h1>
			    <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				    <div class="inner">
					    <div class="app-card-body p-3 p-lg-4">
						    <h3 class="mb-3" style="color:rgba(0, 243, 101, 0.775);" style=" text-decoration: underline;">Moon sight Today</h3>
						    <div class="row gx-5 gy-3">
							
						        <div class="col-12 col-lg-9">   
									
									<img src="{{URL::asset('students_photo')}}/moon.jpg" alt="moonimage" width="100%" style="border-radius: 24px;">
							    ...
							    <div class="col-12 col-lg-3">
									When Moon will show up today?
									<p></p>


					
			<form action="arabicdate" method="POST">
				@csrf
				@method("POST")
			...
			<h6 style=" text-decoration: underline;">English Date</h6>
		<h4>"<?php
...
<p></p>
<p></p>
<h6 style=" text-decoration: underline;">Arabic Date</h6>
				<h4>	<?php
...
if(!empty($check)){
echo $check->arabic_date;
$datenext = $check->arabic_date;
}else{
	echo $date2[3];
	$datenext = $date2[3];
}
...
$arr =explode('-',$datenext);
$checkday = ltrim($arr[0], '"');
...
?>
			...
			<?php if($checkday>27){ ?>	
								<button type="submit" class="btn app-btn-primary" ><i class="fas fa-moon"></i> submit</button>
							</form>
							<?php } ?>
						    </div>
