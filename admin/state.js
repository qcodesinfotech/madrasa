...
$(function () {
    ...
    for (var i = 0; i < handles.length; i++) {
        options +=
            '<option value="' + handles[i] + '">' + handles[i] + "</option>";
    }
    ...
    if ($val == "Goa") {
        ...
        $(function () {
            ...
            for (var i = 0; i < goa.length; i++) {
                options +=
                    '<option value="' + goa[i] + '">' + goa[i] + "</option>";
            }
            $("#secondlist").html(options);
        });
    }
